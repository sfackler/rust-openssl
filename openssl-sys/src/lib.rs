...
pub struct EC_METHOD {
    ...
    pub points_make_affine: Option<unsafe extern "C" fn(*const EC_GROUP, size_t, *mut [EC_POINT], *mut BN_CTX) -> c_int>,
    pub mul: Option<unsafe extern "C" fn(*const EC_GROUP, *mut EC_POINT, *const BIGNUM, size_t, *const [EC_POINT], *const [BIGNUM], *mut BN_CTX) -> c_int>,
