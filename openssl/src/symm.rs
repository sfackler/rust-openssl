...
impl Cipher {
    ...
    #[cfg(not(any(boringssl_flavour, osslconf = "OPENSSL_NO_BF")))]
    ...
    #[cfg(not(any(boringssl_flavour, osslconf = "OPENSSL_NO_SEED")))]
...
mod tests {
    ...
    #[test]
    #[cfg(not(any(boringssl_flavour, osslconf = "OPENSSL_NO_SEED", ossl300)))]
    fn test_seed_cbc() {
        #[cfg(ossl300)]
        let _provider = crate::provider::Provider::try_load(None, "legacy", true).unwrap();
