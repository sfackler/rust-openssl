...
use ssl::SslVersion;
use ssl::{
    Error, HandshakeError, MidHandshakeSslStream, ShutdownResult, ShutdownState, SrtpProfileId, Ssl, 
	SslAcceptor, SslConnector, SslContext, SslFiletype, SslMethod, SslSessionCacheMode, SslStream, SslVerifyMode, StatusType,
};
...
/// being valid for both.
#[test]
#[cfg(all(any(ossl102, libressl261),not(libressl270)))]
