...
impl Cipher {
    ...
    #[cfg(not(any(boringssl_flavour, osslconf = "OPENSSL_NO_CAMELLIA")))]
    ...
    #[cfg(not(any(boringssl_flavour, osslconf = "OPENSSL_NO_CAST")))]
    ...
    #[cfg(not(any(boringssl_flavour, osslconf = "OPENSSL_NO_IDEA")))]
