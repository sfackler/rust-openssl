...
pub const PSPECIFIED: Nid = Nid(ffi::NID_pSpecified);
...
pub const RLE_COMPRESSION: Nid = Nid(ffi::NID_rle_compression);
...
pub const AES_128_CBC_HMAC_SHA256: Nid = Nid(ffi::NID_aes_128_cbc_hmac_sha256);
pub const AES_192_CBC_HMAC_SHA256: Nid = Nid(ffi::NID_aes_192_cbc_hmac_sha256);
pub const AES_256_CBC_HMAC_SHA256: Nid = Nid(ffi::NID_aes_256_cbc_hmac_sha256);
pub const DHPUBLICNUMBER: Nid = Nid(ffi::NID_dhpublicnumber);
pub const BRAINPOOLP160R1: Nid = Nid(ffi::NID_brainpoolP160r1);
pub const BRAINPOOLP160T1: Nid = Nid(ffi::NID_brainpoolP160t1);
pub const BRAINPOOLP192R1: Nid = Nid(ffi::NID_brainpoolP192r1);
pub const BRAINPOOLP192T1: Nid = Nid(ffi::NID_brainpoolP192t1);
pub const BRAINPOOLP224R1: Nid = Nid(ffi::NID_brainpoolP224r1);
pub const BRAINPOOLP224T1: Nid = Nid(ffi::NID_brainpoolP224t1);
pub const BRAINPOOLP256R1: Nid = Nid(ffi::NID_brainpoolP256r1);
pub const BRAINPOOLP256T1: Nid = Nid(ffi::NID_brainpoolP256t1);
pub const BRAINPOOLP320R1: Nid = Nid(ffi::NID_brainpoolP320r1);
pub const BRAINPOOLP320T1: Nid = Nid(ffi::NID_brainpoolP320t1);
pub const BRAINPOOLP384R1: Nid = Nid(ffi::NID_brainpoolP384r1);
pub const BRAINPOOLP384T1: Nid = Nid(ffi::NID_brainpoolP384t1);
pub const BRAINPOOLP512R1: Nid = Nid(ffi::NID_brainpoolP512r1);
pub const BRAINPOOLP512T1: Nid = Nid(ffi::NID_brainpoolP512t1);
pub const DHSINGLEPASS_STDDH_SHA1KDF_SCHEME: Nid = Nid(ffi::NID_dhSinglePass_stdDH_sha1kdf_scheme);
pub const DHSINGLEPASS_STDDH_SHA224KDF_SCHEME: Nid = Nid(ffi::NID_dhSinglePass_stdDH_sha224kdf_scheme);
pub const DHSINGLEPASS_STDDH_SHA256KDF_SCHEME: Nid = Nid(ffi::NID_dhSinglePass_stdDH_sha256kdf_scheme);
pub const DHSINGLEPASS_STDDH_SHA384KDF_SCHEME: Nid = Nid(ffi::NID_dhSinglePass_stdDH_sha384kdf_scheme);
pub const DHSINGLEPASS_STDDH_SHA512KDF_SCHEME: Nid = Nid(ffi::NID_dhSinglePass_stdDH_sha512kdf_scheme);
pub const DHSINGLEPASS_COFACTORDH_SHA1KDF_SCHEME: Nid = Nid(ffi::NID_dhSinglePass_cofactorDH_sha1kdf_scheme);
pub const DHSINGLEPASS_COFACTORDH_SHA224KDF_SCHEME: Nid = Nid(ffi::NID_dhSinglePass_cofactorDH_sha224kdf_scheme);
pub const DHSINGLEPASS_COFACTORDH_SHA256KDF_SCHEME: Nid = Nid(ffi::NID_dhSinglePass_cofactorDH_sha256kdf_scheme);
pub const DHSINGLEPASS_COFACTORDH_SHA384KDF_SCHEME: Nid = Nid(ffi::NID_dhSinglePass_cofactorDH_sha384kdf_scheme);
pub const DHSINGLEPASS_COFACTORDH_SHA512KDF_SCHEME: Nid = Nid(ffi::NID_dhSinglePass_cofactorDH_sha512kdf_scheme);
pub const DH_STD_KDF: Nid = Nid(ffi::NID_dh_std_kdf);
pub const DH_COFACTOR_KDF: Nid = Nid(ffi::NID_dh_cofactor_kdf);
pub const CT_PRECERT_SCTS: Nid = Nid(ffi::NID_ct_precert_scts);
pub const CT_PRECERT_POISON: Nid = Nid(ffi::NID_ct_precert_poison);
pub const CT_PRECERT_SIGNER: Nid = Nid(ffi::NID_ct_precert_signer);
pub const CT_CERT_SCTS: Nid = Nid(ffi::NID_ct_cert_scts);
pub const JURISDICTIONLOCALITYNAME: Nid = Nid(ffi::NID_jurisdictionLocalityName);
pub const JURISDICTIONSTATEORPROVINCENAME: Nid = Nid(ffi::NID_jurisdictionStateOrProvinceName);
pub const JURISDICTIONCOUNTRYNAME: Nid = Nid(ffi::NID_jurisdictionCountryName);
